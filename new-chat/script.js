const monsters = [
  { id: 1, name: "고블린", hp: 20, damage: 10, rewardHp: 2, rewardAtk: 2, rewardSpd: 0, rewardCoin: 80, map: 1 },
  { id: 2, name: "굶주린 망령", hp: 22, damage: 8, rewardHp: 3, rewardAtk: 1, rewardSpd: 0, rewardCoin: 80, map: 1 },
  { id: 3, name: "스켈레톤", hp: 15, damage: 15, rewardHp: 1, rewardAtk: 3, rewardSpd: 1, rewardCoin: 70, map: 1 },
  { id: 4, name: "점액 나무", hp: 25, damage: 5, rewardHp: 4, rewardAtk: 0, rewardSpd: 0, rewardCoin: 80, map: 1 },
  { id: 5, name: "마석 바위 골렘", hp: 18, damage: 12, rewardHp: 0, rewardAtk: 0, rewardSpd: 0, rewardCoin: 100, map: 1 },
  { id: 6, name: "그림울프", hp: 15, damage: 15, rewardHp: 2, rewardAtk: 2, rewardSpd: 0, rewardCoin: 80, map: 1 },
  { id: 7, name: "가시멧돼지", hp: 22, damage: 8, rewardHp: 3, rewardAtk: 1, rewardSpd: 0, rewardCoin: 80, map: 1 },
  { id: 8, name: "잿빛 슬라임", hp: 20, damage: 10, rewardHp: 1, rewardAtk: 3, rewardSpd: 1, rewardCoin: 70, map: 1 },
  { id: 9, name: "불씨도마뱀", hp: 18, damage: 12, rewardHp: 4, rewardAtk: 0, rewardSpd: 0, rewardCoin: 80, map: 1 },
  { id: 10, name: "검은버섯", hp: 25, damage: 5, rewardHp: 0, rewardAtk: 0, rewardSpd: 0, rewardCoin: 100, map: 1 },
  { id: 11, name: "목기인", hp: 20, damage: 10, rewardHp: 2, rewardAtk: 2, rewardSpd: 0, rewardCoin: 80, map: 2 },
  { id: 12, name: "알루미늄 휴먼", hp: 20, damage: 10, rewardHp: 2, rewardAtk: 2, rewardSpd: 0, rewardCoin: 80, map: 2 },
  { id: 13, name: "썩은 드래곤의 유해", hp: 20, damage: 10, rewardHp: 2, rewardAtk: 2, rewardSpd: 0, rewardCoin: 80, map: 2 },
];
